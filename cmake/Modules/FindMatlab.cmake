## TODO: the standard FindMatlab.cmake module provided by cmake is dirty
## Provide :
...
##
## Created/updated by jesnault (jerome.esnault@inria.fr)
if(WIN32)
...
elseif(UNIX)
	...
	endforeach()
	if(NOT MATLAB_EXECUTABLE AND MATLAB_EXE_LIST)
