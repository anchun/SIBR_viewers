...
namespace sibr
{
	...
	*/
	...
	public:
		...
		*/
		static void saveAsBundle(const std::vector<InputCamera::Ptr> & cams, const std::string & fileName, bool negativeZ = false, bool exportImages = false);
		...
		* \returns the loaded cameras
		*/
		static std::vector<InputCamera::Ptr> loadBundle(const std::string& bundlerPath,  float zNear = 0.01f, float zFar = 1000.0f, const std::string & listImagePath = "");
