...
crop_app = executables_folder + "distordCrop" + executables_suffix +".exe"
...
# Scaled down dataset will be stored insdei <destination_folder>/scaledDown
...
crop_from_center_app = os.path.join(executables_folder, "cropFromCenter" + executables_suffix +".exe")
