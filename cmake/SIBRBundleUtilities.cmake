# SIBR NOTES:
# Why did I copy/edit this BundleUtilities.cmake from official cmake's module ?
# It seems that the install system of ibr_common uses the function fixup_bundle
# from BundleUtilities.cmake. This install system call this function for each
# executables of the repos. However this 'bundle' function consider the whole
# directory as a bundle; it automatically process all executables in the
# provided path. I removed this automatic things so now this function only
# process deps for the executable provided by the install system.
# There is a guy having the same problem, but no answer:
# https://cmake.org/pipermail/cmake/2013-November/056356.html
...
#include("${CMAKE_CURRENT_SOURCE_DIR}/SIBRGetPrerequisites.cmake")
    ...
    if(IS_DIRECTORY "${app}")
      if(app MATCHES "\\.app$")
        ...
        if(EXISTS "${app}" AND EXISTS "${executable}")
          ...
          message(STATUS "-- infos --: *NOT* handled - .app directory case...")
        endif()
      else()
        message(STATUS "-- infos --: *NOT* handled - directory but not .app case...")
      endif()
    else()
      ...
      if(is_executable)
        ...
        message(STATUS "-- infos --: *NOT* handled - not .app dir, not executable file...")
      endif()
    endif()
  else()
    message(STATUS "-- infos --: *NOT* handled - directory/file does not exist...")
  endif()
...
function(set_bundle_key_values keys_var context item exepath dirs copyflag)
  ...
  if(NOT length_before EQUAL length_after)
    ...
    #message("-- infos --: item key '${key}' already in the list, subsequent references assumed identical to first")
  endif()
endfunction()
...
function(get_bundle_keys app libs dirs keys_var)
  ...
  message(STATUS "exec are: ${executable}")
  if(valid)
...
function(copy_resolved_item_into_bundle resolved_item resolved_embedded_item)
  ...
  if("${resolved_item_compare}" STREQUAL "${resolved_embedded_item_compare}")
    message(STATUS "-- infos --: resolved_item == resolved_embedded_item - not copying...")
  else()
...
function(fixup_bundle_item resolved_embedded_item exepath dirs)
  ...
  foreach(pr ${prereqs})
    ...
    if(NOT "${${rkey}_EMBEDDED_ITEM}" STREQUAL "")
      ...
      message("-- infos --: unexpected reference to '${pr}'")
    endif()
  endforeach()
