...
#define IMGUI_API SIBR_GRAPHICS_EXPORT
...
#define IM_VEC2_CLASS_EXTRA                                                 \
        ImVec2(const sibr::Vector2f& f) { x = f.x(); y = f.y(); }                       \
        operator sibr::Vector2f() const { return sibr::Vector2f(x,y); }

#define IM_VEC4_CLASS_EXTRA                                                 \
        ImVec4(const sibr::Vector4f& f) { x = f.x(); y = f.y(); z = f.z(); w = f.w(); }     \
        operator sibr::Vector4f() const { return sibr::Vector4f(x,y,z,w); }
*/
