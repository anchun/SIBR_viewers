...
- Generate.
- Download glfw3 from https://gforge.inria.fr/frs/download.php/file/36912/glfw-3.2.1.7z and copy the glfw-3.1.2 directory into extlibs/win64-msvc2017/.
...
A lot of Python scripts are in src/preprocess/scripts. 
...
- A lot of basic apps will depend on ulr, spixelwarp, selection and preprocutils.
